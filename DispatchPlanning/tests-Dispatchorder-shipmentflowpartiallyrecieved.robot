...
*** Test Cases ***
Dispatch planning for Partially recieved
    login devsite
...
#    wait until page contains   ${salesorder_number}
    ...
    Wait For Elements State      //span[text()="Partially Dispatched"]  visible  timeout=60s
    Log  ${itemData1[0]}  # Should log Fgitem1
    Log  ${itemData1[1]}  # Should log 100
    Log  ${itemData1[2]}
#    wait until element is visible  //span[text()="${itemData1[0]}"]/../../../../../../../../../../td[2][text()="${itemData1[2]} piece"]/../../../../../../../div[2]//tr[2]//th[text()="${itemData2}[0] piece"][1]/..//th[text()="${itemData2}[0] piece"][2]
#    Wait Until Element Is Visible  //span[text()="${itemData1[0]}"]/../../../../../../../../../../td[2][text()="${itemData1[2]} piece"]  timeout=20s
    ${value}  Set Variable  ${itemData1}[2]-${itemData2}[0]
    ${remainingvalue}  Evaluate  eval("${value}")
    #wait until element is visible    //th[text()="${itemData2}[0] piece"][1]
    ...
    Wait For Elements State      //span[text()="${itemData1}[0]"]/../../../../../../../../../td[2][text()="${itemData1}[2] piece"]/../td[3][text()="${itemData2}[0] piece"]/../td[4][text()="${remainingvalue} piece"]/../td[5]//span[text()="Partially Dispatched"]  visible  timeout=60s
