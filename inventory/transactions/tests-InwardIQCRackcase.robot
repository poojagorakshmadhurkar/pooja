...
IQC allok rack case
    ...
    Search and Check Item Quantity with iqc with rackcase  ${itemData1}[0]  ${itemData1}[1]  Test_Employee04  Pooja30
    Search and Check Item Quantity with iqc with rackcase  ${itemData2}[0]  ${itemData2}[1]  Test_Employee04  Pooja30
    Search and Check Item Quantity with iqc with rackcase  ${itemData3}[0]  ${itemData3}[1]  Test_Employee04  Pooja30
    open warehouse
