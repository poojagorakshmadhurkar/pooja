...
#    Wait For Elements State     //a[text()="${item2}"]    visible  timeout=30s
    ...
    ${Rmitem2}   item onhand stock    ${item3}
    ...
    click  ${nxtbtnfg}
    click  ${nxtbtnfg}
#    Wait For Elements State    //a[text()="${item2}"]/../../../../../../../../../../../td[text()="${Rmitem1} jar"]   visible  timeout=60s
...
#    Wait For Elements State    //a[text()="${item4}"]/../../../../../../../../../../../td[text()="${Rmitem3} g"]    visible  timeout=60s
    ...
    sleep  1
    click  ${createPobtn}
    Wait For Elements State         //div[text()=" Orders Created"]     visible  timeout=60s
    click   ${vieworders}