...
${filterButton}  //button[@id = "rules__filterBtn"]
${machineFilter}  //input[@id = "machines"]
${itemFilter}  //input[@id = "items"]
${processFilter}  //input[@id = "process"]
${valueFilter}  //input[@id = "value"]
${dailyTarget}  //input[@id = "daily_target"]
