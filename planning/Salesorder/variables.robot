...
${productionDropdown}    //*[text()="Production"]
...
${rejectedreasonfiltersearchbar}  (//*[name()='svg'][@id='live_inventory_Rejection Reason_search'])[2]
${rejectedreasoninputsearch}  (//input[@id='rc_select_2'])[1]
