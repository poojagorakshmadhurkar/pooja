...
Dispatch planning for Partially recieved
    ...
    wait until element is visible  //span[text()="Partially Dispatched"]
    Log  ${itemData1[0]}  # Should log Fgitem1
    Log  ${itemData1[1]}  # Should log 100
    Log  ${itemData1[2]}
    wait until element is visible  //span[text()="${itemData1}[0]"]/../../../../../../../../../td[2][text()="${itemData1}[2] piece"]/../td[3][text()="${itemData2}[0] piece"]/../td[4][text()="${itemData2}[0] piece"]
    Wait Until Element Is Visible  //span[text()="${itemData1[0]}"]/../../../../../../../../../td[2][text()="${itemData1[2]} piece"]  timeout=20s
    Wait Until Element Is Visible  //td[3][text()="${itemData2}[0] piece"]/../td[4][text()="${itemData2}[0] piece"]
    ...
    wait until element is visible  //span[text()="${itemData1}[0]"]/../../../../../../../../../td[2][text()="${itemData1}[2] piece"]/../td[3][text()="${itemData2}[0] piece"]/../td[4][text()="${remainingvalue} piece"]/../td[5]//span[text()="Partially Dispatched"]
