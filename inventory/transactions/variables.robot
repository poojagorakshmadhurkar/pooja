...
${inspectedByDropdown}  //input[@id="inward__form__inspected_by"]
...
${autolotscrollbar}  //button[@id="credit__details__autogenerate_lot"]
${searchItem}  //input[@placeholder='Search Item Details']
${barcodebutton}  (//*[name()='svg'][@class='MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-vubbuv'])[6]
