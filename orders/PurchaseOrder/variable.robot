...
${ORDERS}   //*[text()='Orders']
${INVENTRY}  //*[normalize-space(text())='Inventory']   #//span[text()='Inventory']
${JOBWORK}   //*[text()='Jobwork']
${DASHBOARD}  //*[text()='Dashboards']
...
${REFRESH}   //*[@id="live_inventory_refresh"]
...
${AFTER CLK SORT DATA2}     //td[contains(@class, 'ant-table-cell') and contains(@class, 'ant-table-column-sort')]

${PARTNER ITEM DETAILS COLUMN DATA}   //td[@class="ant-table-cell"][2]
${ORDERED (Primary) COLUMN DATA}    //td[@class="ant-table-cell"][3]
${DELEVERD COLUMN DATA}     //td[@class="ant-table-cell"][4]
${REJECTED COLUMN DATA}    //td[@class="ant-table-cell"][5]
${REMAINING COLUMN DATA}  //td[@class="ant-table-cell"][6]
${VENDER COLUMN DATA}  //td[@class="ant-table-cell"][7]
${ISSUE DATE COLUMN DATA}   //td[@class="ant-table-cell"][8]
${ISSUE DATE COLUMN LIST}   //td[@class="ant-table-cell"][2]
${DELIVERY DATE COLUMN DATA}    //td[@class="ant-table-cell"][9]
${DELIVERY DATE COLUMN DATA2}    //td[@class="ant-table-cell"][3]
${PRICE COLUMN DATA}    //td[@class="ant-table-cell"][10]
${CREATED BY COLUMN DATA}   //td[@class="ant-table-cell"][11]
${APPROVED BY COLUMN DATA}  //td[@class="ant-table-cell"][12]
${STATUS COLUMN LIST}   //td[@class="ant-table-cell"][13]
...
${SORT_VENDER}  (//span[@class='ant-table-column-sorter-inner'])[2]
${SORT_ISSUE_DATE}  (//span[@class='ant-table-column-sorter-inner'])[3]
${SORT_DELIVERY_DATE}   (//span[@class='ant-table-column-sorter-inner'])[4]
...
${SEARCH ICON}      svg[id='purchase_order_PO Number_search']
...
${Vendor SEARCH ICON}   (//*[@id="purchase_order_Vendor_search"])[1]
${Vendor SEARCH ICON2}   (//*[@id="purchase_order_Vendor_search"])[2]
${Vendor SEARCH ICON INPUT FIELD}   (//input[@type="search"])[2]
...
${vendorDrpdwn}   //input[@id="inward__form__partner"]
...
${ISSUE_DATE_CALENDER}     (//*[@placeholder='Select date'])[1]
${DELIVERY_DATE_CALENDER}   (//input[@placeholder='Select date'])[2]
${CURRENT_DATE}     //a[contains(text(),'Today')]
${ITEM_CODE}    //input[@id="purchase_order_0_sku"]    #(//span[@class='ant-select-selection-item'])[3]
...
${CLICK_PO_DETAILS}   (//*[@id="purchase_order_details"])[1]
${CLICK_APPROVE}    //*[normalize-space(text())='Approve']


${INPUT_QUANTITY}   (//input[@class='ant-input'])[2]
${INPUT_PRICE}  //input[@id='purchase_order_0_price_per_unit']
${PRICE}    purchase_order_0_price_per_unit
...
${SUBMIT1}  (//*[text()='Submit'])[1]
${SUBMIT5}  (//button[text()='Submit'])[3]
${SUBMIT3}  //*[@id="credit__rejections__submit"]
${SUBMIT4}  //span[text()='Submit']

${BACK1}   (//*[@id='back_btn'])[2]
${PO_ITEM_DETAILS_SEARCH}  //*[@id='purchase_order_Item Details_search']
${ITEM_DETAILS_SEARCH_ICON}  (//*[@id="purchase_order_Item Details_search"])[2]
${ITEM_DETAILS_SEARCH_INPUTBOX}  (//*[@class="ant-select-selection-search-input"])[2]
${ITEM_DETAILS_SEARCH_INPUTBOX2}  (//*[@class="ant-select-selection-search-input"])[1]

${move to top}  //button[text()='Move to Top']
${checkbox}    (//input[@type="checkbox"])[1]
${Auto_fill}    //*[text()='AutoFill']
${withdraw-Status}   (//span[text()='Closed'])[1]
...
${PERFORM_IQC_FIRST}  //*[text()="perform IQC first"]
#${IQC_PENDING}  //a[contains(text(),'${GRN_No}')]/../../../..//td[10]    #//span[text()='IQC Pending'])[1]
${MRN_APPROVE_NOTE}   //div[text()='MRN approved SuccesFully']
${REJECTION_QTY2}    //span[text()='4']
${OUTWARD}  //div[text()='Outward']
${CLICK_ON_ROW}    (//tr[@class="ant-table-row ant-table-row-level-0"])[11]//td[3]
${CLICK_ON_ROW1}    (//*[@class="ant-table-tbody"]//tr[2][@class="ant-table-row ant-table-row-level-0"])[2]//td[3]     #(//tr[@class="ant-table-row ant-table-row-level-0"])[3]//td[3]
...
${PO_REJECT}    (//*[@id="purchase_order_reject "])[1]
...
${REJECTION_INPUTBOX}   //input[@id="credit__rejections__0__0__quantity"]
...
${inward_note_txt}   //div[contains(@style, 'text-align: center;')]
${TRANSACTION_STATUS}   (//tr[@class='ant-table-row ant-table-row-level-0'])[1]//td[10]
${ACTION_BUTTON}    (//*[@id="transaction_credit_approve"])[1]
...
${EDIT}     //*[@id="credit__rejections__edit"]     #//*[@id="credit__details__edit"]
${ALL_OK}   //*[@id="credit__rejections__all_ok"]
...
${REJECTION_Text}   //*[@id="rc-tabs-5-tab-rejection"]
${SCROLL}   document.evaluate("(//div[@class='ant-table-body'])[2]", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.scrollLeft = document.evaluate("(//div[@class='ant-table-body'])[2]", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.scrollWidth;
${EDIT_PO}  //*[@data-icon="edit"]
${xpath_price1}    //td[text()="₹25.00  per piece"]
${WAREHOUSES_ITEM_DATA}   //tr[@class="ant-table-row ant-table-row-level-0"]
${REJECT}   //a[text()="Reject"]
${PO_WITHDRAW}   (//button[@id="undefined__deactivate_btn"])[2]
${PO_Approve}   //*[@id="purchase_order_approve"]
${PO_Approved}  (//*[@id="purchase_order_approve"])[1]
${PO_STATUS}    (//span[@class='ant-tag ant-tag-yellow'])[1]
${INSPECTION REPORT}    //span[text()="Inspection Report"]
${INPUT_INSPECTION VALUE}    //input[@id="inspection_input"]
${PO_QTY_INPUBOX}    //input[@id='purchase_order_0_quantity']
${CANCELICON}   //*[@data-testid="CancelIcon"]
${INVENTORY}    //span[text()='Inventory']